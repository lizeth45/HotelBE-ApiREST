...
public class ServiciosCons {
	...
	public ServiciosCons(Time horaServcons, Date diaServcons, Double montoServcons, Servicio servicio,
			Estancia estancia) {
		super();
	...
	public Double getMontoServcons() {
		return montoServcons;
	}

	public void setMontoServcons(Double montoServcons) {
		this.montoServcons = montoServcons;
	}
